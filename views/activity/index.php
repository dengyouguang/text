...
<div>
    ...
    <p style="font-size:1.5em;text-align: center;margin:1em auto">DC Export深度清洁膏状面膜</p>
    <p style="text-align: center;color:red">（官方活动：购买259元DC深度清洁面膜，送129元48小时焕肤套装）</p>
</div>
<div id="img">
    <?php
        echo Html::img('images/product.jpg',['width'=>'100%']);
        for ($i=2; $i<=25 ; $i++) {
            echo Html::img($i<10 ? "images/product_01_0".$i.'.jpg' : "images/product_01_".$i.'.jpg',['width'=>'100%']);
        }
    ?>
</div>
<hr />
...
<div style="margin-top: 10px;">
    ...
    <?= $form->field($model, 'goods')->hiddenInput(['value'=>'深度清洁膏状面膜'])->label(false) ?>
...
<div style="width:90%;margin: 0 auto;clear: both">
    ...
    <div class="shuxing" style="display: none">
        <table class="table">
            ...
            <tr>
                <td>[产品规格/容量]</td><td>100g</td>
            </tr>
            <tr>
                <td>[主要成份]</td><td>氧化锌、液体石蜡、辛酸/癸酸甘油三酯、蜂蜡、微晶蜡、蛋黄油、羊毛脂、角鲨烯、聚异丁烯、卵磷脂、山梨坦油酸酯、薰衣草（LAVANDULA ANGUSTIFOLIA）油、苯甲酸苄酯、肉桂酸苄酯</td>
            </tr>
            <tr>
                <td>[使用部位]</td><td>面部</td>
            </tr>
