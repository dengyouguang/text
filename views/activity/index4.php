...
<div>
    <p style="font-size:1.5em;text-align: center;margin:1em auto">DC Export48小时焕肤套装（臻礼版） </p>
    <p style="text-align: center;color:red">经典钜惠套129元=DC Export48小时焕肤套装（臻礼版） 。</p>
</div>
<div id="img">
    <img src="images/product4.jpg" width="100%"/>
    <img style="margin:10px 0" src="images/intro4.jpg" width="100%"/>
</div>
<hr />
...
<div style="margin-top: 10px;">
    ...
    ?>
    <div style="margin:10px 5%">数量：<button type="button" id="cut">-</button><input id="activityorder-num" style="width: 10%;margin-left:0"  type="text" value="1" name="Activityorder[num]"><button type="button" id="add">+</button>  总价：<b>129</b>.00元</div>
    ...
    <?= $form->field($model, 'goods')->hiddenInput(['value'=>'48小时焕肤套装'])->label(false) ?>

    <?= $form->field($model, 'phone', ['inputOptions' => ['placeholder' => "手机号"]])->textInput()->label(false) ?>

    <!--<input type="text" name="code" style="width:55%;"/><button class="btn btn-default" type="button" id="btn">获取验证码</button>-->    
    <div class="col-lg-7">
    ...
    <?= $form->field($model, 'total', ['inputOptions' => ['placeholder' => '总价']])->hiddenInput(['value' => 129])->label(false) ?>
...
<div style="width:90%;margin: 0 auto;clear: both">
    ...
    <div class="shuxing" style="display: none">
        <table class="table">
            ...
            <tr>
                <td>[产品规格/容量]</td><td>深层补水日夜保湿面膜20ml+深度清洁膏状面膜8g+OPC深润养护原液精华套2ml+1ml</td>
            </tr>
        </table>
        <hr />
    </div>
...
<br/>
<hr />
<a href="<?= Url::to(['activity/index4'])?>">
    <div>
        <img src="images/product_03.jpg" width="90%" style="margin-left:5%">
        <p style="margin:20px auto"><button class="btn btn-success" style="float:right">购买</button></p>
    </div>
</a>
<br/>
